...
namespace NendUnityPlugin.Callback
{
	...
	public interface NendAdInterstitialCallback
	{
		...
		[Obsolete ("Use 'NendUnityPlugin.AD.NendAdInterstitial.AdLoaded' instead.", true)]
		...
		[Obsolete ("Use 'NendUnityPlugin.AD.NendAdInterstitial.AdClicked' instead.", true)]
		...
		[Obsolete ("Use 'NendUnityPlugin.AD.NendAdInterstitial.AdShown' instead.", true)]
